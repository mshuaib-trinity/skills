...
Checks:
  ...
  - CLAUDE.md and AGENTS.md exist and are identical mirrors
...
check((root / "CLAUDE.md").exists(), "CLAUDE.md is missing")
...
# CLAUDE.md and AGENTS.md must be exact mirrors (MIRROR RULE).
