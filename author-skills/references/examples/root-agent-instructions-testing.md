# Testing Root Agent Instructions for Skill Use

Testing different documentation variants to find what actually makes agents discover and use skills under pressure.

Set `$SKILLS_DIR` to the active skill directory for the setup:
- agents-only: `~/.agents/skills`
- claude+agents: `~/.agents/skills` or `~/.claude/skills`
...
No mention of skills in root agent instructions at all.
